                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <br><br>
                            {!! Form::select('Intensidad_dolor',['Seleccione una respuesta',0 => value(' (0) Puedo soportar el dolor sin necesidad de tomar calmantes ') ,1=>value(' (1) El dolor es fuerte pero me arreglo sin tomar calmantes '),2=>value(' (2) Los calmantes me alivian completamente el dolor '),3=>value(' (3) Los calmantes me alivian un poco el dolor '),4=>value(' (4) Los calmantes apenas me alivian el dolor '),5=>value('(5) Los calmantes no me alivian el dolor y no los tomo')], null,['class' => 'form-control'])!!}
                        </div>
                        <div class="form-group">
